...
//hier wird eine f�r flash codierte datei wieder f�r html lesbar gemacht.
...
function cleanfilename($input){
	$string = eregi_replace("[�]","oe",$input);
	$string = eregi_replace("[�]","ae",$string);
	$string = eregi_replace("[�]","ue",$string);
