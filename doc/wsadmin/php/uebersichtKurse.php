...
$result = mysqli_query($conn1, $mysqlquery);
			...
			while ($row = mysqli_fetch_array($result)){
				if ( $i >= $Pstart && $i <= $Pend ){
					...
					echo "	<td class='TDdatum'>".htmlspecialchars($beginn, ENT_QUOTES, 'UTF-8')."</td>\n";
					echo "	<td class='TDdatum'>".htmlspecialchars($ende, ENT_QUOTES, 'UTF-8')."</td>\n";
					echo "	<td class='TDzahl'>".htmlspecialchars($row["platz_kurse"], ENT_QUOTES, 'UTF-8')."</td>\n";
					echo "	<td class='TDzahl'>".htmlspecialchars($row["teilnehmer_kurse"], ENT_QUOTES, 'UTF-8')."</td>\n";
					echo "	<td class='TDdatum'>".htmlspecialchars($datum, ENT_QUOTES, 'UTF-8')."</td>\n";
