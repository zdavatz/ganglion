...
- Homepage notice box: `doc/index.php` has a `praxis-hinweis` table (CSS in `browser5.css`) under the navbar, currently announcing the practice closure per end of 2026 with a link to `doc/html/pdf/Praxisschliessung_2026.pdf`. Remove or replace it there when outdated.
